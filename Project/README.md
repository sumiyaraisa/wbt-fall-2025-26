...
📂 File Structure
index.php: The landing page showcasing available internships.
login.php / logout.php: User authentication and session handling.
company.php: Main dashboard for company users.
admin.php: Statistical overview for administrators.
post_internship.php: Logic for creating new internship entries.
manage_internship.php: Logic for updating or closing postings.
